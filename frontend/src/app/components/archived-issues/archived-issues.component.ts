        ...
        <p-table [value]="filteredIssues()" [(selection)]="selected" selectionMode="multiple" dataKey="id"
          ...
          <ng-template pTemplate="body" let-issue>
            <tr [class.internal-issue]="issue.internal">
              ...
              <td>{{ issue.archivedAt | date:'dd/MM/yyyy HH:mm' }}</td>
            </tr>
          </ng-template>
...
export class ArchivedIssuesComponent {
  ...
  load(): void {
    ...
    this.error.set(null);
    this.issuesApi.archivedIssues(projectId).subscribe({
