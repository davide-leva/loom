...
import type { IssueNotificationSummary } from '../../shared/models/notification.types';

describe('IssueNotificationsService', () => {
  let service: IssueNotificationsService;
  let http: HttpTestingController;
  let auth: { authHeaders: jest.Mock };

  const summary: IssueNotificationSummary = {
    projectId: 1,
    total: 3,
    planning: 1,
    anomalies: 1,
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(IssueNotificationsService);
